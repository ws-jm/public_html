...
function createChart(rowsData) {
    ...
    var leg = lineschart.root.querySelector(".legend");
    ...
    $(lineschart.root.querySelector(".legend")).appendTo('#legend-chart .uplot');
    ...
    if (candleActive) {
        ...
        candlechart.root.style.visibility = 'hidden';
        window.addEventListener("resize", throttle(() => {
    ...
    if (volumeActive) {
        ...
        var leg = volumechart.root.querySelector(".legend");
        ...
        $(volumechart.root.querySelector(".legend")).find('.series:nth-of-type(1)').remove();
        $(volumechart.root.querySelector(".legend")).appendTo('#legend-chart .uplot');
    ...
    var y = lineschart.root.querySelector(".cursor-y");
    var plot = lineschart.root.querySelector(".over");

    if (volumeActive) {
        var y2 = volumechart.root.querySelector(".cursor-y");
        var plot2 = volumechart.root.querySelector(".over");
    }
    if (candleActive) {
        var y3 = candlechart.root.querySelector(".cursor-y");
        var plot3 = candlechart.root.querySelector(".over");
    }
    ...
    $("#legend-chart .legend .series th").on('click', function (e) {
    ...
    $("#legend-chart .legend:nth-of-type(2) .series:nth-of-type(1) th").on('click', function (e) {
        $("#legend-chart .legend:nth-of-type(2) .series:nth-of-type(2) th").click();
        if ($("#legend-chart .legend:nth-of-type(2) .series:nth-of-type(1)").hasClass("off")) {
        ...
        switch ($.trim($(args).text())) {
            case "Candlestick":
                if (candleActive) {
                    ...
                    if (isChecked) {
                        lineschart.root.style.visibility = 'hidden';
                        candlechart.root.style.visibility = 'visible';

                        if (linessubchart !== undefined) {
                            linessubchart.root.style.visibility = 'hidden';
                            candlesubchart.root.style.visibility = 'visible';
                        }
                    } else {
                        candlechart.root.style.visibility = 'hidden';
                        lineschart.root.style.visibility = 'visible';

                        if (linessubchart !== undefined) {
                            candlesubchart.root.style.visibility = 'hidden';
                            linessubchart.root.style.visibility = 'visible';
                        }
                    }
                }
                break;
            ...
            case "Hints":
                ...
                if (candleActive) {
                    candlechart.root.querySelector(".legend").style.visibility = isChecked ? "visible" : "hidden";

                    if (candlesubchart !== undefined)
                        candlesubchart.root.querySelector(".legend").style.visibility = isChecked ? "visible" : "hidden";
                }
                break;
    ...
    lineschart.root.querySelector('.over').oncontextmenu = function (event) {
    ...
    if (candleActive)
        candlechart.root.querySelector('.over').oncontextmenu = function (event) {
            var scrollTop = $(window).scrollTop();
            var scrollLeft = $(window).scrollLeft();
            contextMenuChart.jqxMenu('open', parseInt(event.clientX) + 5 + scrollLeft, parseInt(event.clientY) + 5 + scrollTop);
            return false;
    ...
    if (linessubchart !== undefined) {
        ...
        if (candleActive) {
            ...
            $('.chart-hints').toggle(candlesubchart.root.querySelector(".legend").style.visibility !== "hidden");
            candlechart.root.querySelector(".legend").style.visibility == candlesubchart.root.querySelector(".legend").style.visibility
        }
    } else {
        if (candleActive)
            candlechart.root.querySelector(".legend").style.visibility = "hidden";
...
function createSubChart(rowsData) {
    ...
    var leg = linessubchart.root.querySelector(".legend");
    ...
    $(linessubchart.root.querySelector(".legend")).appendTo('#legend-subchart .uplot');
    window.addEventListener("resize", throttle(() => {
    ...
    if (volumeActive) {
        ...
        var leg = volumesubchart.root.querySelector(".legend");
        $(leg).find('.series:last-child').hide();
        ...
        $(volumesubchart.root.querySelector(".legend")).find('.series:nth-of-type(1)').remove();
        $(volumesubchart.root.querySelector(".legend")).appendTo('#legend-subchart .uplot');
    ...
    var ys = linessubchart.root.querySelector(".cursor-y");
    var plots = linessubchart.root.querySelector(".over");

    if (volumeActive) {
        var y2s = volumesubchart.root.querySelector(".cursor-y");
        var plot2s = volumesubchart.root.querySelector(".over");
    }

    if (candleActive) {
        var y3s = candlesubchart.root.querySelector(".cursor-y");
        var plot3s = candlesubchart.root.querySelector(".over");
    }
    ...
    $("#legend-subchart .legend .series th").on('click', function (e) {
        if ($(this).parent().hasClass('off')) {
            $(this).find('.ident').css({"background-color": "transparent"});
        } else {
            $(this).find('.ident').css({"background-color": $(this).find('.ident').css("border-color")});
    ...
    $("#legend-subchart .legend:nth-of-type(2) .series:nth-of-type(1) th").on('click', function (e) {
        $("#legend-subchart .legend:nth-of-type(2) .series:nth-of-type(2) th").click();
        if ($("#legend-subchart .legend:nth-of-type(2) .series:nth-of-type(1)").hasClass("off")) {
    ...
    window.addEventListener("resize", throttle(() => {
        ...
        if (getParameterByName("tab") == "prices" && $('#top-subchart').width() > 10) {
            console.log("prices");
            let old_size = zoomsubchart.width,
                old_position = $(".zoom-subpanel")[0].offsetLeft,
    ...
    linessubchart.root.querySelector('.over').oncontextmenu = function (event) {
        var scrollTop = $(window).scrollTop();
        var scrollLeft = $(window).scrollLeft();
    ...
    if (candleActive)
        candlesubchart.root.querySelector('.over').oncontextmenu = function (event) {
            var scrollTop = $(window).scrollTop();
            var scrollLeft = $(window).scrollLeft();
            contextMenuSubChart.jqxMenu('open', parseInt(event.clientX) + 5 + scrollLeft, parseInt(event.clientY) + 5 + scrollTop);
            return false;
...
// after how much time chat loads or start displaying
    ...
    if (lineschart !== undefined) {
        ...
        if (candleActive) {
            ...
            $('.chart-hints').toggle(candlechart.root.querySelector(".legend").style.visibility !== "hidden");
            candlesubchart.root.querySelector(".legend").style.visibility == candlechart.root.querySelector(".legend").style.visibility
        }
    } else {
        if (candleActive)
            candlesubchart.root.querySelector(".legend").style.visibility = "hidden";
